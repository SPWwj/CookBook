...
abstract class DishesRoomDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile
        private var INSTANCE: DishesRoomDatabase? = null
        ...
        private class DishesDatabaseCallback(
            ...
            override fun onOpen(db: SupportSQLiteDatabase) {
                ...
                INSTANCE?.let {
                    scope.launch {
                        //populateDatabase(database.dishesDao())
                    }
                }
            }
        }
         ...
         */
        suspend fun populateDatabase(dishesDao: DishesDao) {
